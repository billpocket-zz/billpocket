...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		//TODO: Es un parche bastante malo
		var str = settings.oLanguage.sSearch;

		var customHTML =   '<div class="col-lg-4 col-md-8 col-sm-8 col-xs-8">'+
						    '<div class="input-group">'+
						      '<input type="search" placeholder="'+ classes.sFilterPlaceholder+'" class="'+classes.sFilterInput+'"/>'+
						      '<span class="input-group-btn">'+
						        '<button class="btn btn-default btn-sm" type="button" data-bind="click: clearFilterAction">X</button>'+
						      '</span>'+
						    '</div><!-- /input-group -->'+
						  '</div><!-- /.col-lg-6 -->';
